...
extern float render_view_x, render_view_y, render_view_width, render_view_height;
...
void render_faces_range_xy (void (*render_line) (int, int, int, int), int from, int to);
